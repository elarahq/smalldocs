...
/**
 * Send error json to response
 */
func (this *Context) ErrorJSON(w http.ResponseWriter, data interface{}, status int) error {
	jsonData, err := json.Marshal(data)
	if err != nil {
		return err
	}
...
// pointed to by v.
func (this *Context) ReadJson(r *http.Request, v interface{}) error {
...
func (this *Context) IsAjax(r *http.Request) bool {
